                ...
                <div class="email-container">
                    ...
                    <div class="email-content">
                        ...
                        <p class="main-text">
                            We received a request to reset the password for your account on <span
                                class="brand-highlight">Go Jobs</span>. Use this OTP to complete the password reset
                            process.
                        </p>

                        <p class="warning-text">
                            Remember, Never share this OTP with anyone, not even if <span class="brand-highlight">Go
                                Jobs</span> asks you.
                        </p>
                        ...
                        <div class="verification-section">
                            ...
                            <div class="verification-code" id="verificationCode">${otp} <span class="tooltip">Click to
                                    Copy</span> </div>
                    ...
                    <div class="social-section">
                        ...
                        <div class="email-signature">
                            ...
                            <p class="team-name">Team <span class="brand-highlight">Go Jobs</span>.</p>
                        </div>
                    </div>
                </div>
            </td>
